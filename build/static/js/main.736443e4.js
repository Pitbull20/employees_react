/*! For license information please see main.736443e4.js.LICENSE.txt */
!(function () {
	'use strict';
	var e = {
			725: function (e) {
			...
			463: function (e, t, n) {
				...
				function Ra(e, t) {
					switch (
						(fl(La, t), fl(Ta, e), fl(Oa, Na), (e = t.nodeType))
					) {
						case 9:
						case 11:
				...
				function hi(e, t, n) {
					...
					$t(e, t, n), e === Ru && ((Bu |= t), 4 === Fu && gi(e, Iu));
					var r = Wl();
					1 === t
						? 0 !== (8 & zu) && 0 === (48 & zu)
							? bi(e)
				...
				function vi(e) {
					...
					return (
						yi(e, $l()),
						e.callbackNode === t ? vi.bind(null, e) : null
					);
				}
				function gi(e, t) {
					for (
				...
				var is = { Events: [rl, ll, al, Le, ze, Ii, { current: !1 }] },
					ss = {
	...
	!(function () {
		...
		var v = n(184);
		var g = function (e) {
				var t = e.numberOfEmployees,
					n = e.numberOfIncrease;
				return (0, v.jsxs)('div', {
					className: 'app-info',
					children: [
						(0, v.jsx)('h1', {
							children:
								'\u041e\u0431\u043b\u0456\u043a \u043f\u0440\u0430\u0446\u0456\u0432\u043d\u0438\u043a\u0456\u0432 \u043a\u043e\u043c\u043f\u0430\u043d\u0456\u0457 ',
						}),
						(0, v.jsxs)('h2', {
							children: [
			...
			b = (function (e) {
				...
				function n(e) {
					...
					return (
						i(this, n),
						((r = t.call(this, e)).onUpdateSearch = function (e) {
							var t = e.target.value;
							r.setState({ term: t }), r.props.onUpdateSearch(t);
						}),
						(r.state = { term: '' }),
						r
					);
		...
		var w = function (e) {
			var t = [
				...
				var n = t.name,
					r = t.label,
					l = e.filter === n ? 'btn-light' : 'btn-outline-light';
				return (0, v.jsx)(
					'button',
					{
						className: 'btn '.concat(l),
						onClick: function () {
							return e.onFilterSelect(n);
						},
						type: 'button',
						children: r,
					},
			...
			return (0, v.jsx)('div', { className: 'btn-groupe', children: t });
		};
		function k(e, t) {
			if (null == e) return {};
			var n,
		...
		var S = function (e) {
				var t = e.name,
					n = e.salary,
					r = e.onDelete,
					l = e.onToggleIncrease,
					a = e.onToggleRise,
					o = 'list-group-item d-flex justify-content-between';
				return (
					e.increase && (o += ' increase'),
					e.rise && (o += ' like'),
					(0, v.jsxs)('li', {
						className: o,
						children: [
		...
		var x = function (e) {
			...
			_ = (function (e) {
				...
				function n(e) {
					...
					return (
						i(this, n),
						((r = t.call(this, e)).onValueChange = function (e) {
							r.setState(a({}, e.target.name, e.target.value));
						}),
						(r.onSubmit = function (e, t, n) {
							e.preventDefault(),
								t.length > 3 &&
									t &&
									n &&
									(r.props.onAddEmployees(t, n),
									r.setState({ name: '', salary: '' }));
						}),
						(r.state = { name: '', salary: '' }),
						r
					);
			...
			C = (function (e) {
				...
				function n(e) {
					...
					return (
						i(this, n),
						((r = t.call(this, e)).deletItem = function (e) {
						...
						(r.onUpdateSearch = function (e) {
							r.setState({ term: e });
						}),
						(r.filterPost = function (e, t) {
							switch (t) {
								case 'rise':
						...
						(r.idCounter = r.state.data.length),
						r
					);
				}
				return (
							...
							value: function () {
								var e = this.state,
									...
									a = t.reduce(function (e, t) {
										return t.increase && (e += 1), e;
									}, 0);
								return (0, v.jsxs)('div', {
									className: 'app',
									children: [
										(0, v.jsx)(g, {
											numberOfEmployees: t.length,
											numberOfIncrease: a,
										}),
										(0, v.jsxs)('div', {
		...
		t.render(
			(0, v.jsx)(e.StrictMode, { children: (0, v.jsx)(C, {}) }),
			document.getElementById('root')
		);
	})();
})();
//# sourceMappingURL=main.736443e4.js.map
